...
library PermitHash {
    ...
    function hash(IAllowanceTransfer.PermitSingle memory permitSingle)
        internal
        pure
        returns (bytes32)
    {
    ...
    function hash(IAllowanceTransfer.PermitBatch memory permitBatch)
        internal
        pure
        returns (bytes32)
    {
    ...
    function _hashPermitDetails(IAllowanceTransfer.PermitDetails memory details)
        private
        pure
        returns (bytes32)
    {
